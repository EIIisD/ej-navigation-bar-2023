...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, mode, size, variant, asChild = false, unstyled = false, ...props }, ref) => {
    const Comp = asChild ? Slot : "button"

    return <Comp className={cn(!unstyled && buttonVariants({ mode, size, variant }), className)} ref={ref} {...props} />
  }
)
